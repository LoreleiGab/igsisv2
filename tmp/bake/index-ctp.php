...
?>
                <td class="actions" style="white-space:nowrap">
                    ...
                    <CakePHPBakeOpenTag= $this->Form->postLink(__('Excluir'), ['action' => 'delete', <?= $pk ?>], ['confirm' => __('Você tem certeza que deseja excluir # {0}?', <?= $pk ?>), 'class'=>'btn btn-danger btn-xs']) CakePHPBakeCloseTag>
                </td>
            </tr>
    ...
    <div class="paginator">
        <center>
            ...
            <p><CakePHPBakeOpenTag= $this->Paginator->counter(__('Página {{page}} de {{pages}}, mostrando {{current}} registros de um total de
         {{count}}, começando no registro {{start}}, terminando em {{end}}')) CakePHPBakeCloseTag></p>
        </div>
    </center>
</div>
</div>