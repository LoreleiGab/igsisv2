...
<nav class="col-lg-2 col-md-3">
    <ul class="nav nav-pills nav-stacked">
        <li class="active"><a href=""><CakePHPBakeOpenTag= __('Ação') CakePHPBakeCloseTag></a></li>
        <li><CakePHPBakeOpenTag= $this->Html->link(__('Editar {0}', ['<?= $singularHumanName ?>']), ['action' => 'edit', <?= $pk ?>]) CakePHPBakeCloseTag> </li>
        <li><CakePHPBakeOpenTag= $this->Form->postLink(__('Excluir {0}', ['<?= $singularHumanName ?>']), ['action' => 'delete', <?= $pk ?>], ['confirm' => __('Você tem certeza que deseja excluir # {0}?', <?= $pk ?>)]) CakePHPBakeCloseTag> </li>
        <li><CakePHPBakeOpenTag= $this->Html->link(__('Listar {0}', ['<?= $pluralHumanName ?>']), ['action' => 'index']) CakePHPBakeCloseTag> </li>
        <li><CakePHPBakeOpenTag= $this->Html->link(__('Novo {0}', ['<?= $singularHumanName ?>']), ['action' => 'add']) CakePHPBakeCloseTag> </li>
<?php
    $done = [];
...
?>
        <li><CakePHPBakeOpenTag= $this->Html->link(__('Listar {0}', ['<?= $this->_pluralHumanName($alias) ?>']), ['controller' => '<?= $details['controller'] ?>', 'action' => 'index']) CakePHPBakeCloseTag> </li>
        <li><CakePHPBakeOpenTag= $this->Html->link(__('Novo {0}', ['<?= Inflector::humanize(Inflector::singularize(Inflector::underscore($alias))) ?>']), ['controller' => '<?= $details['controller'] ?>', 'action' => 'add']) CakePHPBakeCloseTag> </li>
<?php
...
<?php foreach ($details['fields'] as $field): ?>
                <th><?= Inflector::humanize($field) ?></th>
<?php endforeach; ?>
                <th class="actions"><CakePHPBakeOpenTag= __('Ação') CakePHPBakeCloseTag></th>
            </tr>
...
<?php $otherPk = "\${$otherSingularVar}->{$details['primaryKey'][0]}"; ?>
                <td class="actions">
                    <CakePHPBakeOpenTag= $this->Html->link(__('Visualizar'), ['controller' => '<?= $details['controller'] ?>', 'action' => 'view', <?= $otherPk ?>]) ?>

                    <CakePHPBakeOpenTag= $this->Html->link(__('Editar'), ['controller' => '<?= $details['controller'] ?>', 'action' => 'edit', <?= $otherPk ?>]) ?>

                    <CakePHPBakeOpenTag= $this->Form->postLink(__('Excluir'), ['controller' => '<?= $details['controller'] ?>', 'action' => 'delete', <?= $otherPk ?>], ['confirm' => __('Você tem certeza que deseja excluir # {0}?', <?= $otherPk ?>)]) ?>
