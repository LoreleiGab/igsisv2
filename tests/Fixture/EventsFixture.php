...
class EventsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'author' => ['type' => 'text', 'length' => 4294967295, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        'technical_form' => ['type' => 'text', 'length' => 4294967295, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        'age_group_id' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'synopsis' => ['type' => 'text', 'length' => 4294967295, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        'release_communication' => ['type' => 'text', 'length' => 4294967295, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        'links' => ['type' => 'text', 'length' => 4294967295, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            ...
            'fk_Evento_Usuario_idx' => ['type' => 'index', 'columns' => ['fiscal_id'], 'length' => []],
            ...
            'fk_Evento_Projeto_especial_idx' => ['type' => 'index', 'columns' => ['especial_project_id'], 'length' => []],
        ...
        '_constraints' => [
            ...
            'fk_Evento_Projeto_especial' => ['type' => 'foreign', 'columns' => ['especial_project_id'], 'references' => ['special_projects', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            ...
            'fk_Evento_Usuario_fiscal' => ['type' => 'foreign', 'columns' => ['fiscal_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_Evento_Usuario_suplente' => ['type' => 'foreign', 'columns' => ['surrogate_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
