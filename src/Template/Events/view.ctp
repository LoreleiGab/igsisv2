<div class="events view col-lg-10 col-md-9">
    ...
    <table class="table table-striped table-hover">
        ...
        <tr>
            ...
            <td><?= $event->has('juridical_relation') ? $this->Html->link($event->juridical_relation->id, ['controller' => 'JuridicalRelations', 'action' => 'view', $event->juridical_relation->id]) : '' ?></td>
        </tr>
        <tr>
            <th>Special Project</th>
            <td><?= $event->has('special_project') ? $this->Html->link($event->special_project->id, ['controller' => 'SpecialProjects', 'action' => 'view', $event->special_project->id]) : '' ?></td>
        </tr>
        <tr>
            <th>Type Event</th>
            <td><?= $event->has('type_event') ? $this->Html->link($event->type_event->id, ['controller' => 'TypeEvents', 'action' => 'view', $event->type_event->id]) : '' ?></td>
        </tr>
        <tr>
            <th>Age Group</th>
            <td><?= $event->has('age_group') ? $this->Html->link($event->age_group->id, ['controller' => 'AgeGroups', 'action' => 'view', $event->age_group->id]) : '' ?></td>
        </tr>
        <tr>
            <th>Producer</th>
        ...
        <tr>
            <th>Institution</th>
            <td><?= $event->has('institution') ? $this->Html->link($event->institution->id, ['controller' => 'Institutions', 'action' => 'view', $event->institution->id]) : '' ?></td>
        </tr>
        <tr>
            <th>Public Target</th>
        ...
        <tr>
            <th>'Fiscal Id</th>
            <td><?= $this->Number->format($event->fiscal_id) ?></td>
        </tr>
        <tr>
            <th>'Surrogate Id</th>
            <td><?= $this->Number->format($event->surrogate_id) ?></td>
        </tr>
        <tr>
            <th>Date Send</th>
