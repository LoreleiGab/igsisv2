...
<div class="surrogates view col-lg-10 col-md-9">
    ...
    <div class="related">
        ...
        <table class="table table-striped table-hover">
            ...
            <?php foreach ($surrogate->events as $events): ?>
            <tr>
                <td><?= h($events->id) ?></td>
                <td><?= h($events->name) ?></td>
    ...
    <div class="related">
        ...
        <?php if (!empty($surrogate->internal_events)): ?>
        <table class="table table-striped table-hover">
            <tr>
                <th>Id</th>
                <th>Name</th>
            ...
            <?php foreach ($surrogate->internal_events as $internalEvents): ?>
            <tr>
