<nav class="col-lg-2 col-md-3">
    <ul class="nav nav-pills nav-stacked">
        ...
        <li><?= $this->Html->link(__('Editar {0}', ['User']), ['action' => 'edit', $user->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Excluir {0}', ['User']), ['action' => 'delete', $user->id], ['confirm' => __('Você tem certeza que deseja excluir # {0}?', $user->id)]) ?> </li>
        <li><?= $this->Html->link(__('Listar {0}', ['Users']), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('Novo {0}', ['User']), ['action' => 'add']) ?> </li>
