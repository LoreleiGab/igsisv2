...
class CallsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['TypeCalls', 'Events', 'Users']
        ];
    ...
    public function view($id = null)
    {
        $call = $this->Calls->get($id, [
            'contain' => ['TypeCalls', 'Events', 'Users', 'Status', 'CallComments', 'LogReopenings']
        ]);
    ...
    public function add()
    {
        ...
        $typeCalls = $this->Calls->TypeCalls->find('list', ['limit' => 200]);
        $events = $this->Calls->Events->find('list', ['limit' => 200]);
        $users = $this->Calls->Users->find('list', ['limit' => 200]);
        $status = $this->Calls->Status->find('list', ['limit' => 200]);
        $this->set(compact('call', 'typeCalls', 'events', 'users', 'status'));
        $this->set('_serialize', ['call']);
    }
