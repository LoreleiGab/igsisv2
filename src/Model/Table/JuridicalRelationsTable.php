...
class JuridicalRelationsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('juridical_relations', 'create')
            ->notEmpty('juridical_relations')
            ->add('juridical_relations', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);
    ...
    {
        $rules->add($rules->isUnique(['juridical_relations']));
